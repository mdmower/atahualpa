...
function src_simple_recent_comments($src_count=7, $src_length=40, $pre_HTML='', $post_HTML='') {
	global $wpdb;
	...
	foreach ($comments as $comment) {
		$output .= "\n\t<li><a href=\"" . get_permalink($comment->ID) . "#comment-" . $comment->comment_ID  . "\" title=\"On: " . $comment->post_title . "\">" . $comment->comment_author . ": " . strip_tags($comment->com_excerpt) . "...</a></li>";
	}
	$output .= $post_HTML;
