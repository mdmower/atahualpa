...
<li><a href="#" id="css-javascript-tab" rel="css-javascript">Configure CSS & JS</a></li>
</ul>
...
<div class="bfa-container">
    <div class="bfa-container-full"><img src="<?php echo get_bloginfo('template_directory'); ?>/options/images/post-structure.gif" 
	style="float: right; margin: 40px 0 15px 15px;">
	<label for="Post Info Items">Post Info Items</label>
	Configure a <strong>Kicker</strong>, a <strong>Byline</strong> and a <strong>Footer</strong> for posts and pages by 
	arranging these <strong>Post Info Items</strong>. 
...
<ul>
	...
	<li>Replace the parameter <code>delimiter</code> with what you want to put between the list items of the tag or category 
	list, i.e. a comma.</li>
	<li>Replace the parameters <code>before</code> and <code>after</code> with what you want to display before or after that 
	info item. If an item has these "before/after" parameters, use them instead of 
	hard coding text before and after that item: Example: Use <br /><code>%tags-linked('<i>Tags: </i>', '<i>, </i>', '<i> - </i>')%</code>
	<br />instead of<br /><code>Tags: %tags-linked('', '<i>, </i>', '')% - </code></li>
...
foreach ($files as $key => $file) {
	...
	$url_base.'/images/icons/'.$file.'" /> &nbsp;<code>&lt;image('.$file.')&gt;</code></span>';
}
...
<hr>	
<code>%author%</code> - Displays the value in the user's Display name publicly as field.
<hr>
<code>%modified-author%</code> - For <strong>WordPress 2.8</strong> and newer <strong>ONLY</strong>: 
...
<hr>
<code>%author-description%</code> - Displays the contents of the About yourself field in an 
author's profile (Administration > Profile > Your Profile).
<hr>
<code>%author-login%</code> - Displays the login name of the author of a post. The login is also 
referred to as the Username an author uses to gain access to a WordPress blog.
<hr>
<code>%author-firstname%</code> - Displays the first name for the author of a post. The First Name 
field is set in the user's profile (Administration > Profile > Your Profile).
<hr>
<code>%author-lastname%</code> - Displays the last name for the author of a post. The Last Name field 
is set in the user's profile (Administration > Profile > Your Profile).
<hr>
<code>%author-nickname%</code> - Displays the nickname for the author of a post. The Nickname field 
is set in the user's profile (Administration > Profile > Your Profile).
<hr>
<code>%author-id%</code> - Displays the unique numeric user ID for the author of a post; the ID is 
assigned by WordPress when a user account is created.
<hr>
<code>%author-email-clear%</code> - Displays the email address for the author of a post. The E-mail 
...
<hr>
<code>%author-email%</code> - Displays the email address for the author of a post, obfuscated by using 
the internal function antispambot() to encode portions in HTML character 
entities (these are read correctly by your browser).
<hr>
<code>%author-url%</code> - Displays the URL (not a full link) to the Website for the author of a post. The Website field 
is set in the user's profile (Administration > Profile > Your Profile).
<hr>
<code>%author-link%</code> - Displays a link to the Website for the author of a post. The Website field is 
...
<hr>
<code>%author-posts-link%</code> - Displays a link to all posts by an author. The link text is the user's 
Display name publicly as field.
<hr>
<code>%author-post-count%</code> - Displays the total number of posts an author has published. Drafts and 
private posts aren't counted.
<hr>
<code>%author-aim%</code> - Displays the AOL Instant Messenger screenname for the author of a post. 
The AIM field is set in the user's profile (Administration > Profile > Your Profile).
<hr>
<code>%author-yim%</code> - Displays the Yahoo IM ID for the author of a post. The Yahoo IM field is 
set in the user's profile (Administration > Profile > Your Profile).
<hr>
<code>%date('F jS, Y')%</code> - Display the date and/or time the post was published at. Many configuration 
...
<hr>
<code>%tags-linked('before', 'delimiter', 'after')%</code> - Displays the tags associated with 
...
<hr>
<code>%tags-cats-linked('before', 'delimiter', 'after')%</code> - Same as above but if no tags 
...
<hr>
<code>%tags('before', 'delimiter', 'after')%</code> - Displays the tags associated with 
the current post. Tags are not linked.
<br /><strong>Example:</strong> <code>%tags-linked('<i>Tags: </i>', '<i> - </i>', '<i>. </i>')%</code>
<hr>
<code>%category%</code> - Displays the name of the <strong>first</strong> category a post belongs to.
<hr>
<code>%category-linked%</code> - Displays a link to the <strong>first</strong> category a post belongs to.
<hr>
<code>%categories('delimiter')%</code> - Displays the names of all categories a post belongs to, separated 
by delimiter.
<br /><strong>Example:</strong> <code>%categories('<i>, </i>')%</code>
<hr>
<code>%categories-linked('delimiter')%</code> - Displays links to all categories a post belongs to, separated 
by delimiter.
<br /><strong>Example:</strong> <code>%categories-linked('<i> | </i>')%</code>
<hr>
<code>%comments('No comments', '1 comment', '% comments', 'Comments closed')%</code> - Displays a 
link to the comment section of the post. The link text depends on the comment count & status (open/closed). 
<br /><br /><strong>When using this item, provide 4 text strings for the 4 possible comment states:</strong>
<ul>
...
<hr>
<code>%comments-rss('linktext')%</code> - Displays the comment feed link for a post, with linktext as the link text.
<hr>
<code>%trackback%</code> - Displays the trackback URL for the current post.
<hr>
<code>%trackback-linked('linktext')%</code> - Displays a link to the trackback URL, with linktext as the link text.
<hr>
<code>%trackback-rdf%</code> - Displays the trackback RDF information for a post. This information is not displayed 
...
<hr>
<code>%permalink%</code> - Displays the URL for the permalink to the post.
<hr>
<code>%post-id%</code> - Displays the numeric ID of the post.
<hr>
<code>%post-title%</code> - Displays the title of the post.
<hr>
<code>%post-title-encoded%</code> - Displays the title of the post. It somewhat duplicates the functionality of 
...
<hr>
<code>%edit('before', 'linktext', 'after')%</code> - Displays a direct edit link for the post, IF the current viewer 
...
<hr>
<code>%print('linktext')%</code> - Displays a link with <em>linktext</em> as the link text, which, when clicked, 
...
<hr>
<code>%wp-print%</code> - Displays a link to a print preview page of the post. A configurable alternative to the 
...
<hr>
<code>%wp-email%</code> - Displays a link to a form where visitors can e-mail the post to others. Requires 
...
<hr>
<code>%wp-postviews%</code> - Displays how many times the post was viewed. Requires the plugin 
...
<hr>
<code>%wp-postratings%</code> - Displays stars or other graphics showing the vote/rating of a post, and lets visitors rate the post.
...
<hr>
<code>%sociable%</code> - Displays little icons, linking the post to social bookmark sites. Requires the plugin 
...
<hr>
<code>%share-this%</code> - Displays little icons, linking the post to social bookmark sites. Requires the plugin 
<a href="http://wordpress.org/extend/plugins/share-this/">Share This</a>. 
<hr>
<code>%meta%</code> - Displays all custom fields and their values as unordered list &lt;ul&gt;&lt;li&gt;..&lt;/li&gt;&lt;li&gt;..&lt;/li&gt;&lt;/ul&gt;
<hr>
<code>%meta('fieldname')%</code> - Displays the value of the custom field with the field name "fieldname".
<br /><strong>Example:</strong> <code>%meta('<i>price</i>')%</code>
<hr>
<code>&lt;?php echo "Hello world!"; ?&gt;</code> - In regular WordPress (but not in WPMU), you can use PHP code, too. 
...
if ($value['type'] == "text") { 
	...
	if ( get_option( $value['id'] ) !== FALSE) 
		...
		stripslashes(format_to_edit(get_option( $value['id'] ))) : 
		get_option( $value['id'] ) ); 
	else  
		echo ( $value['editable'] == "yes" ? 
...
<tbody>
	<tr><td>Left Margin for whole Item</td><td>Left Border Width for Links</td><td>Left Border Color for Links</td>
...
#	$value['id'] . '" cols="35" style="width: 95%" rows="6">';
...
elseif ($value['type'] == "select") { 
	...
	foreach ($value['options'] as $option) { 
		...
		elseif ( get_option( $value['id']) === FALSE AND $option == $value['std'])  
			echo ' selected="selected"'; 
