...
return str_replace('iepngfix.php', '', $protocol."://".$_SERVER['SERVER_NAME'].$port.$_SERVER['REQUEST_URI']);
}
...
/* This must be a path to a blank image, relative to the HTML document(s).
   ...
   NOTE by BFA: This will be figured out automatically, unless you changed file names of blank.gif or iepngfix.php,
   or moved them around: */
IEPNGFix.blankImg = '<?php echo selfURL(); ?>blank.gif';
